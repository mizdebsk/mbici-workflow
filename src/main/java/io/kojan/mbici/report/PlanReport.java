...
public class PlanReport extends Report {
    ...
    public void body() {
        header("Test plan");
        para(
                "Plan describes a way to build RPM packages. It specifies what ",
                "packages are built, in which order and with what RPM macros defined.");
        para(
                "Plan consists of consecutive phases. Each phase consists of a ",
        ...
        para(
                "Plan does not specify sources for each component. That information is part of ",
                link("subject.html", "test subject"),
                ".");
        para(
                "Machine-readable information about test plan in XML format can be found in ",
                link("plan.xml", "plan.xml"),
        ...
        list(
                ...
                "There are no global macros defined.",
                plan.getMacros(),
        ...
        for (var phase : plan.getPhases()) {
            ...
            list(
                    ...
                    "There are no components in this phase.",
                    phase.getComponents(),
                    component -> component);
        }
