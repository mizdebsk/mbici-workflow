    ...
    private static final Entity<WorkspaceConfig, WorkspaceConfig> confEntity =
            Entity.ofMutable(
                    ...
                    Attribute.ofOptional(
                            "kubeNamespace",
                            WorkspaceConfig::getKubeNamespace,
                            WorkspaceConfig::setKubeNamespace),
                    Attribute.ofOptional(
                            "kubeContainerImage",
                            WorkspaceConfig::getKubeContainerImage,
                            WorkspaceConfig::setKubeContainerImage),
                    Attribute.ofOptional(
                            "kubeCacheVolumeClaimName",
                            WorkspaceConfig::getKubeCacheVolumeClaimName,
                            WorkspaceConfig::setKubeCacheVolumeClaimName),
                    Attribute.ofOptional(
                            "kubeResultVolumeClaimName",
                            WorkspaceConfig::getKubeResultVolumeClaimName,
                            WorkspaceConfig::setKubeResultVolumeClaimName),
                    Attribute.ofOptional(
                            "kubePodRunningTimeout",
                            WorkspaceConfig::getKubePodRunningTimeout,
                            WorkspaceConfig::setKubePodRunningTimeout),
                    Attribute.ofOptional(
                            "kubeSrpmCpuRequest",
                            WorkspaceConfig::getKubeSrpmCpuRequest,
                            WorkspaceConfig::setKubeSrpmCpuRequest),
                    Attribute.ofOptional(
                            "kubeSrpmCpuLimit",
                            WorkspaceConfig::getKubeSrpmCpuLimit,
                            WorkspaceConfig::setKubeSrpmCpuLimit),
                    Attribute.ofOptional(
                            "kubeRpmCpuRequest",
                            WorkspaceConfig::getKubeRpmCpuRequest,
                            WorkspaceConfig::setKubeRpmCpuRequest),
                    Attribute.ofOptional(
                            "kubeRpmCpuLimit",
                            WorkspaceConfig::getKubeRpmCpuLimit,
                            WorkspaceConfig::setKubeRpmCpuLimit),
                    Attribute.ofOptional(
                            "kubeSrpmMemoryRequest",
                            WorkspaceConfig::getKubeSrpmMemoryRequest,
                            WorkspaceConfig::setKubeSrpmMemoryRequest),
                    Attribute.ofOptional(
                            "kubeSrpmMemoryLimit",
                            WorkspaceConfig::getKubeSrpmMemoryLimit,
                            WorkspaceConfig::setKubeSrpmMemoryLimit),
                    Attribute.ofOptional(
                            "kubeRpmMemoryRequest",
                            WorkspaceConfig::getKubeRpmMemoryRequest,
                            WorkspaceConfig::setKubeRpmMemoryRequest),
                    Attribute.ofOptional(
                            "kubeRpmMemoryLimit",
                            WorkspaceConfig::getKubeRpmMemoryLimit,
                            WorkspaceConfig::setKubeRpmMemoryLimit));
}
