...
public class KubeExecuteCommand extends AbstractExecuteCommand {
    ...
    @Option(names = {"--result-volume-claim-name"}, description = "Name of PersistentVolumeClaim to use for results")
    ...
    public Integer call() throws Exception {
        Kubernetes kubernetes = new Kubernetes(namespace, containerImage, cacheVolumeClaimName, resultVolumeClaimName,
                podRunningTimeout, srpmCpuRequest, srpmCpuLimit, rpmCpuRequest, rpmCpuLimit, srpmMemoryRequest,
